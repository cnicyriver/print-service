...
(function() {
  var CONST, Pos, async, cluster, log, moment, nconf, orm;
  ...
  module.exports = function(db) {
        ...
        print: function(callback) {
          ...
          return this.save((function(_this) {
            return function(err) {
              ...
              _this.print_nums++;
              log("进程,日志……" + cluster.worker.id + "," + _this.print_log_id + "," + initStatus + "," + beforeStauts + "," + _this.is_ok + "," + result + "," + _this.print_nums);
    ...
    print_log.loopFill = function(print_manage_id, callback) {
      ...
      return this.find({
        ...
        return function(err) {
          return _this.loopPrint(callback);
        };
      })(this));
    };
